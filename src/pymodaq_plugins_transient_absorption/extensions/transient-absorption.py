...
from pymodaq_plugins_transient_absorption.utils import Config as PluginConfig
...
EXTENSION_NAME = 'transient-absorption'
CLASS_NAME = 'TransientAbsorption'

class TransientAbsorption(CustomExt):
